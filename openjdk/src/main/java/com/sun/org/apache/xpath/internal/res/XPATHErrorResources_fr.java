...
public static final String ER_IGNORABLE_WHITESPACE_NOT_HANDLED =
 ...
 public static final String ER_ONLY_ALLOWS = "ER_ONLY_ALLOWS";
  ...
  { ER_PREDICATE_TOO_MANY_OPEN,
      "D\u00E9bordement de la pile lors de l''analyse de {0} dans {1}. Nombre de pr\u00E9dicats ouverts trop important ({2})."},

  { ER_COMPILATION_TOO_MANY_OPERATION,
      "D\u00E9bordement de la pile lors de la compilation de l''expression. Nombre d''op\u00E9rations trop important ({0})."},
